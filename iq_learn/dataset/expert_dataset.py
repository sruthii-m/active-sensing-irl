...
class ExpertDataset(Dataset):
    ...
    Expert dataset is a dict with {states, actions, rewards, lengths} with values containing a list of
    expert attributes of given shapes below.
        shapes:
    ...
    def __getitem__(self, i):
        ...
        # rescale states and next_states to [0, 1]
...
def read_file(path: str, file_handle: IO[Any]) -> Dict[str, Any]:
    """Read file from the input path assuming it stores dictionary data.
